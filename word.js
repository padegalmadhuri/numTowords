...
function ones(intArr) {
    return (values[0][intArr]);
}

function tens(intArr) {
    if (intArr[0] == 1) {
        return (values[intArr[0]][intArr[1]]);
    } else if (intArr[0] == 0) {
        return (values[intArr[0]][intArr[1]]);

    } else {
        if (intArr[1] == 0) {
            return (values[2][intArr[0] - 2]);
        } else {
            return (values[2][intArr[0] - 2] + " " + values[0][intArr[1]]);
        }
